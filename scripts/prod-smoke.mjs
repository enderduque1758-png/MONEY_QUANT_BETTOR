...
const html=await readFile('dist/index.html','utf8');for(const s of ['main.js','analytics-ui.js','market-options.js','production-engine.js','integration-core.js']){if(!html.includes(s)){console.error('Missing script in dist/index.html:',s);process.exit(1)}}
...
console.log('Production smoke OK:',required.length,'files + forced scripts + server imports');
